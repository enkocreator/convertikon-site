...
- `index.html` - the homepage: the launch page (live since 24 Sep 2026). Everything inline.
- `index-coming-soon.html` - the pre-launch page, kept for reference (noindex).
...
`SIGNUP.field` (`entry.<question id>`) in `index.html` (the "Stay in touch" block). Connected to the form
...
`terms/index.html` -> convertikon.app/terms.
